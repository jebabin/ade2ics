...
#	Fran¡ois Revol, Francois.Revol in imag.fr
# 
...
if (!defined $ENV{REQUEST_METHOD}) {
	...
	if (!(defined($opts{'a'}) xor defined($opts{'n'})) ) {
		...
		print STDERR " $0 -w -c -l keryell -p some_password -y '2007-2008' -a 'Enseignants:H ‡ K:KERYELL Ronan'\n";
...
$mech->field("showTabDuration", "true");	# Dur™e
$mech->field("aSize", "false");			# Capacit™
...
$mech->field("aNe", "false");			# Note de s™ance
